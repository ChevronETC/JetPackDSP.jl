# JetPackDSP.jl contributor guidelines

## Issue reporting
If you have found a bug in JetPackDSP.jl or have any suggestions for changes to
JetPackDSP.jl functionality, please consider filing an issue using the GitHub
...
making changes to JetPackDSP.jl.
...
git:
  1. fork the JetPackDSP.jl repository
  ...
  4. run `]test JetPackDSP` in the `test` folder
